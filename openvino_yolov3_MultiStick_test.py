...
class NcsWorker(object):
    ...
    def __init__(self, devid, frameBuffer, results, camera_width, camera_height, number_of_ncs, vidfps):
        ...
        self.roop_frame = 0
        self.vidfps = vidfps
        self.new_w = 416#int(camera_width * min(self.m_input_size/camera_width, self.m_input_size/camera_height))
        self.new_h = 416#int(camera_height * min(self.m_input_size/camera_width, self.m_input_size/camera_height))
